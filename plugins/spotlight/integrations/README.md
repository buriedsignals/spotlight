...
Also register in `skills/integrations/SKILL.md`'s routing table so agents can discover it. If journalists should save a key at install time, add it to Indicator Labs.
