...
description: "Phase 5 synthesis sub-skill for Spotlight/data-detective: draft findings-report.md, report.html, and evidence-map.json with replication paths, source strips, confidence/novelty pills, methodology, diagrams, and editor-ready HTML. Use after Gate 1 approval. Triggers on draft the report, build the HTML report, journalist-grade output, synthesis phase, findings report, evidence map, network diagram, or money-flow diagram."
license: MIT
metadata:
