...
| `arbiter` | `skills/arbiter/SKILL.md` | Live `/arbiter` entry point: guides each member through attributed signup and local BYO-key setup, then runs the Data Navigator case-study and deterministic report workflow | investigator, fact-checker, orchestrator, user |
