...
3. **[integrations.md](integrations.md)** — external OSINT tool integrations (Browser Harness, browser-use, Junkipedia, OSINT Navigator, Phantom Tide, Unpaywall), manifest contract, preflight
