...
Canonical 4-column + footer-meta + huge display (landing only).

```html
<section id="footer" data-nav-theme="dark">
  <!-- Landing only: -->
  <p class="footer-huge" id="footer-huge">Lead the <em>story.</em></p>

  <div class="footer-grid">
    <div class="footer-col about">
      <h4>Spotlight</h4>
      <p>Short description — ≤ 38ch.</p>
    </div>
...
Key:
- Padding `140px 48px 40px` (landing w/ huge) or `80px 48px 40px` (setup mini).
- `.footer-grid`: `2fr 1fr 1fr 1fr` gap `40px`; mobile `1fr 1fr` gap `28px`, `.about` column-span 2.
- `.footer-col h4`: M-pill tier.
- `.footer-col ul li a`: M-body-sm, hover → `--accent-warm`.
- `.footer-meta`: flex between, `border-top: 1px solid var(--muted-faint-dark)`, M-meta tier.

**Variant — mini footer** (setup / any non-narrative page): omit `.footer-huge`, padding drops to `80px 48px 40px`.
