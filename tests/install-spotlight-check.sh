...
includes install-spotlight.sh '$NAVIGATOR_URL/api/artifacts/bootstrap/bsig/$platform'
...
excludes install-spotlight.sh '/auth/cli/start'
excludes install-spotlight.sh '/api/artifacts/engine/'
