...
| `arbiter` | `skills/arbiter/SKILL.md` | Temporarily paused `/arbiter` entry point: preserves the Data Navigator case-study and deterministic report workflow while paid-member ownership is resolved | investigator, fact-checker, orchestrator, user |
